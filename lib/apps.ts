...
export const apps: ReachApp[] = [
  ...
  },
  {
    ...
    shortTitle: "Video Studio",
    description: "Reach Video Studio for browser playback and local media.",
    longDescription:
      "Reach Video Studio combines browser-based video and audio playback with familiar controls and a polished distraction-free layout.",
    status: "Live",
    href: "/video-player",
    icon: "🎬",
    category: "Media Tools",
  ...
  },
  {
    ...
    description: "Open the Timepass connection from the ReachMart website.",
    longDescription:
      "The Timepass service is currently unavailable at its separate domain. This page remains the safe connection point from ReachMart Multimedia.",
    status: "Coming Soon",
    href: "/chat",
    icon: "💬",
